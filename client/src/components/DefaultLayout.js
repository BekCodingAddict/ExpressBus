  ...
  return (
    <div className="layout-parent">
      <div className="sidebar">
        ...
        <div className={collapsed? "sidebar-title display-none" : "sidebar-title"}>
              <h1 className="logo">Ex. Bus</h1>
              <h1 className="role">Role : {user?.isAdmin ? 'Admin' : 'User'} <br /><i class="ri-user-line"></i> {user?.name}</h1>
            </div>
